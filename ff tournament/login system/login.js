...
const ADMINS = [
    { email: 'dudhevansh8@gmail.com', password: '2345678910$$', username: 'vansh_dada', phone: '8989921991' },
    { email: 'samarthkhamele@gmail.com', password: 'samarth333', username: 'Samarth', phone: '' }
];
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (event) => {
            ...
            if (result.success) {
                ...
                loginForm.reset();
                const normalizedEmail = email.trim().toLowerCase();
                window.location.href = `../App/index.html?user=${encodeURIComponent(normalizedEmail)}`;
            }
        });
    }
